...
set ylabel "Execution time(s)" font "Helvetica, 12" offset 1,0 

unset xlabel

set ylabel "Execution time(s)" font "Helvetica, 10" offset 1,0 
...
plot newhistogram "", \
     '1vm.csv' using 2:xtic(1) title col with histogram fill pattern 2 linestyle 1, \
     ''      using 3:xtic(1) title col with histogram fill pattern 9 linestyle 2, \
     ''      using 4:xtic(1) title col with histogram fill pattern 5 linestyle 3

unset ylabel

set label "(a) lbzip2-undercommitted" font "Helvetica, 9" offset -20.5,-1.3
set label "(b) lbzip2-overcommitted" font "Helvetica, 9" offset -4,-1.3
set style histogram title offset character 0, 0, 0
...
set key Left at 2.0, 5 reverse vertical height 0.2 width 0 box maxrows 1 font "Helvetica, 10" samplen 1.5

plot newhistogram "", \
     '2vm.csv' using 2:xtic(1) title col with histogram fill pattern 2 linestyle 1, \
     ''      using 3:xtic(1) title col with histogram fill pattern 9 linestyle 2, \
     ''      using 4:xtic(1) title col with histogram fill pattern 5 linestyle 3
