...
for bench in benchmarks:
    ...
    result_case = {}
    result_case["HVM-u"], result_case["err1-1"] = stat.mean(result_bench["hvm"]), stat.pstdev(result_bench["hvm"])
    result_case["PVM-u"], result_case["err1-2"] = stat.mean(result_bench["pvm"]), stat.pstdev(result_bench["pvm"])
